...
export default function NotificationDropdown({ onClose, onNotificationUpdate }: NotificationDropdownProps) {
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      ...
      case "deposit":
        return { bg: "bg-[#000080]/8 dark:bg-[#50C878]/15", text: "text-[#000080] dark:text-[#50C878]" };
      case "withdrawal":
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-white/5">
          <div className="flex items-center space-x-2">
            ...
            {unreadCount > 0 && (
              <span className="px-1.5 py-0.5 bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] text-[10px] font-bold rounded-full">
                {unreadCount}
              </span>
            )}
          </div>
          {unreadCount > 0 && (
            <button
              ...
              className="text-[10px] sm:text-xs text-[#000080] hover:text-[#0000b3] dark:text-[#50C878] dark:hover:text-[#6de496] font-medium transition-colors"
            >
              Mark all read
            </button>
          )}
                  ...
                  <div className="flex items-start space-x-2.5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-0.5">
                        ...
                        {!notification.read && (
                          <div className="w-1.5 h-1.5 bg-[#000080] dark:bg-[#50C878] rounded-full ml-2 mt-1 flex-shrink-0" />
                        )}
                      </div>
        ...
        <div className="px-4 py-2.5 border-t border-gray-100 dark:border-white/5">
          <button
            onClick={handleViewAll}
            className="w-full text-center text-[10px] sm:text-xs text-[#000080] hover:text-[#0000b3] dark:text-[#50C878] dark:hover:text-[#6de496] font-medium transition-colors"
          >

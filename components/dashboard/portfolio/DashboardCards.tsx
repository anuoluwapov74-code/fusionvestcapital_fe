...
export function AssetAllocationCard({
  ...
  const assets = (() => {
    if (totalPortfolio <= 0) {
      return [
        { name: "Balance", value: 0, color: "bg-[#000080]/60" },
        { name: "Deposits", value: 0, color: "bg-[#000080]" },
    ...
    return [
      { name: "Available", value: Math.max(balancePct, 0), color: "bg-[#000080]/60" },
      { name: "Deposits", value: Math.max(depositPct, 0), color: "bg-[#000080]" },
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2.5 mb-4">
        <div className="w-7 h-7 rounded-full bg-[#000080]/8 dark:bg-[#50C878]/15 flex items-center justify-center">
          <TrendingUp className="w-3.5 h-3.5 text-[#000080] dark:text-[#50C878]" />
        </div>

    ...
    >
        ...
        >
          ...
          */}
          <div className="absolute right-0 bottom-10 sm:bottom-auto sm:top-4 w-36 sm:w-44 lg:w-56 flex items-center justify-center pointer-events-none">
            ...
            <span className="absolute bottom-8 left-0 text-white/20 text-[7px] leading-none select-none">
              ✦
            </span>
          ...
          <div className="relative p-3 py-5 lg:p-5">
            ...
            <div>
              <p
                className="text-[9px] font-semibold text-white/80 uppercase tracking-widest mb-1"
              ...
              <p
                className="text-[8px] text-white/60 mt-1 uppercase tracking-wider"
            ...
            <div className="relative z-10 mt-25 lg:mt-5 lg:max-w-112.5 grid grid-cols-2 rounded-xl overflow-hidden bg-white/95 dark:bg-black/30 backdrop-blur-md border border-white/80 dark:border-yellow-400/20">
              <div className="px-4 py-3">
                <p className="text-[9px] font-semibold text-gray-500 dark:text-white/50 uppercase tracking-wider mb-1">
                  Profit
                </p>
      ...
      <div className="flex flex-row justify-center gap-1.5 sm:gap-3 mb-5">
        {[
          ...
          const content = (
            <>
              <action.icon className={`w-3 h-3 sm:w-4 sm:h-4 shrink-0 ${action.primary ? "text-white" : "text-[#000080] dark:text-[#50C878]"}`} />
          ...
          const className = action.primary
            ? "group bg-[#50C878] hover:bg-[#3ab060] border border-[#50C878] rounded-full py-1.5 px-2.5 sm:py-2.5 sm:px-5 flex flex-row items-center gap-1.5 sm:gap-2 transition-all duration-200 shadow-sm shadow-[#50C878]/30"
            : "group bg-white dark:bg-white/4 border border-gray-200 dark:border-white/[0.07] rounded-full py-1.5 px-2.5 sm:py-2.5 sm:px-5 flex flex-row items-center gap-1.5 sm:gap-2 transition-all duration-200 hover:border-[#000080]/40 dark:hover:border-[#50C878]/40 hover:bg-[#000080]/5 dark:hover:bg-white/8 shadow-sm";
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="rounded-xl bg-white/90 dark:bg-[#1a2744]/80 backdrop-blur-xl border border-gray-200/50 dark:border-white/10 p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-2">
              <Wallet className="w-4 h-4 text-[#000080] dark:text-[#50C878]" />

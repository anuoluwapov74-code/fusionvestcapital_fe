    ...
    >
      ...
      {loading ? (
        <div className="flex items-center justify-center py-10">
          <div className="w-5 h-5 border-2 border-[#000080] dark:border-[#50C878] border-t-transparent rounded-full animate-spin" />
        </div>
      ) : isEmpty ? (
        <div className="flex flex-col items-center justify-center py-10 px-5">
          ...
          <Link href="/explore-traders">
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              className="px-5 py-2 bg-[#50C878] hover:bg-[#3ab060] text-white text-xs font-semibold rounded-lg transition-colors"
            >
              Explore Traders
            </motion.button>
          </Link>
        ...
        <div className="flex flex-col items-center justify-center py-6 px-5">
          ...
          <div className="w-full mb-6">
            <input
              ...
              className="w-full px-3 py-2 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-lg text-xs text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-[#000080]/30 dark:focus:ring-[#50C878]/30 transition-all"
              disabled
            />
          </div>
            ...
            {filteredTraders.length === 0 ? (
              ...
              filteredTraders.map((trader) => (
                <Link className="inline-block w-full" key={trader.id} href={`/explore-traders/${trader.trader_id}`}>
                  <div className="flex items-center gap-3 p-3 rounded-lg bg-gray-50 dark:bg-white/5 hover:bg-gray-100 dark:hover:bg-white/10 transition-all cursor-pointer border border-transparent hover:border-[#000080]/25 dark:hover:border-[#50C878]/25">
                    <Image
                    ...
                    <div className="text-right">
                      <p className="text-[10px] font-medium text-[#000080] dark:text-[#50C878]">

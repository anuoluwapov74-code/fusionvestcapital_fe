      ...
      >
        ...
        <div className="px-4 py-4 border-b border-gray-100 dark:border-white/5">
          <div className="flex items-center space-x-3 mb-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#000080] to-[#1a1aff] dark:from-[#50C878] dark:to-[#3ab060] flex items-center justify-center text-white font-semibold text-xs">
              {user
          ...
          <button
            ...
            className="flex items-center space-x-1.5 text-[11px] text-[#000080] dark:text-[#50C878] hover:text-[#0000b3] dark:hover:text-[#6de496] transition-colors font-medium"
          >
        ...
        <div className="py-1">
          ...
          >
            ...
            <span className="text-xs font-medium">About FUSIONVEST CAPITAL</span>
          </button>

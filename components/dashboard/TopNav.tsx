                      ...
                      return (
                        <Link
                          ...
                          className={`flex items-center space-x-2.5 px-4 py-2.5 text-xs font-medium transition-colors ${
                            isActive
                              ? "text-[#000080] dark:text-[#50C878] bg-[#000080]/6 dark:bg-[#50C878]/10"
        ...
        <div className="flex items-center space-x-1.5">
          ...
          <div className="relative">
            ...
            >
              ...
              {notificationCount > 0 && (
                <span className="absolute -top-0.5 -right-0.5 w-4 h-4 bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] text-[10px] font-bold rounded-full flex items-center justify-center">
                  {notificationCount}
                </span>
              )}
            </button>
          ...
          <div className="relative">
            ...
            >
              <div className="w-7 h-7 rounded-full bg-gradient-to-br from-[#000080] to-[#1a1aff] dark:from-[#50C878] dark:to-[#3ab060] flex items-center justify-center text-white font-semibold text-[10px]">
                {user

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-[#000080]/8 dark:border-[#50C878]/8 pt-8">
          <div className="space-y-4 text-xs leading-relaxed text-gray-400 dark:text-gray-500">
            <p>
              Disclaimer: FUSION VEST VENTURES, LLC ( CRD # 331287/SEC#:802-130592 ), a
              ...
              referenced registration numbers. FUSION VEST VENTURES, LLC is a duly
              ...
              indices, and digital assets. FUSION VEST VENTURES, LLC operates across
              ...
              the relevant authorities in their respective regions. FUSION VEST
            ...
            <p>
              ...
              Under no circumstances shall FUSION VEST VENTURES, LLC have any liability to any
              ...
              FUSION VEST VENTURES, LLC by following and/or copying or replicating the trades
              ...
              performance of a FUSION VEST VENTURES, LLC Community Member is not a reliable
              indicator of his future performance. Content on FUSION VEST VENTURES, LLC&apos;s
              ...
              FUSION VEST VENTURES, LLC- Your Social Investment Network.
            </p>
            <p className="pt-2 text-gray-500 dark:text-gray-400">
              Copyright &copy; 2006-2026 FUSION VEST VENTURES, LLC — Your Social Investment Network.
              All rights reserved.
            </p>
          </div>
        </div>

  ...
  const trustBadges = [
    {
      ...
      accentLight: "bg-[#000080]/8 text-[#000080]",
      accentDark: "dark:bg-[#50C878]/10 dark:text-[#50C878]",
    },
    {
      icon: <ReliableIcon />,
      title: "Reliable",
      description: "A leader in the fintech space since 2007",
      accentLight: "bg-[#50C878]/10 text-[#3ab060]",
      accentDark: "dark:bg-[#50C878]/10 dark:text-[#50C878]",
    },
    {
      icon: <SecuredIcon />,
...
const TrustBadge = ({ icon, title, description, accentLight, accentDark }: TrustBadgeProps) => (
  <div className="group flex flex-col items-center rounded-2xl border border-[#000080]/8 dark:border-[#50C878]/8 bg-white/70 dark:bg-white/[0.02] backdrop-blur-sm p-5 text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-[#000080]/5 dark:hover:shadow-[#50C878]/5 hover:border-[#000080]/20 dark:hover:border-[#50C878]/20 lg:p-8">
    <div className={`mb-4 flex h-12 w-12 items-center justify-center rounded-2xl transition-transform duration-300 group-hover:scale-110 ${accentLight} ${accentDark}`}>
      {icon}
    </div>

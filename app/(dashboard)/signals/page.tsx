        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
            ...
            <div className="bg-emerald-500/10 dark:bg-emerald-500/20 border-2 border-emerald-500 rounded-xl px-6 py-4">
              <div className="text-xs md:text-sm text-emerald-500 dark:text-emerald-400 mb-1">
                Wallet Balance
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {signals.map((signal) => (
                  <motion.div
                    ...
                    className="bg-white dark:bg-[#1a2744] rounded-2xl p-6 border border-gray-200 dark:border-white/10 hover:border-emerald-500 dark:hover:border-emerald-500 transition-all"
                  >
                    {/* Header */}

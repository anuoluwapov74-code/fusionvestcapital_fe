          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors text-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {markingAllRead ? (
                  <>
                  ...
                  <motion.div
                    ...
                    className={`bg-white dark:bg-[#1a2744] rounded-xl p-5 border transition-all duration-300 cursor-pointer ${
                      notification.read
                        ...
                        : "border-emerald-500 dark:border-emerald-500 hover:border-emerald-600 dark:hover:border-emerald-600"
                    }`}
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-xs text-emerald-500 hover:text-emerald-600 font-medium">
                            View Details →
                          </span>
                        </div>
                      </div>

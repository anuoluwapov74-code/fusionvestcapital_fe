    ...
    <section className="w-full sm:px-6 lg:px-8 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-6 sm:space-y-8">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-emerald-600 to-emerald-700 dark:from-emerald-700 dark:to-emerald-800 rounded-2xl p-6 sm:p-8 text-white shadow-2xl"
        >
          <div className="flex items-center gap-3 mb-4">
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-all shadow-sm whitespace-nowrap"
              >
                {copied ? (
                  <>
              ...
              <div className="flex items-center justify-between flex-wrap gap-3">
                <div className="flex-1 min-w-0">
                  ...
                  {referralData?.referral_code ? (
                    <p className="text-sm font-bold text-emerald-600 dark:text-emerald-400 font-mono break-all">
                      {referralData.referral_code}
                    </p>
                  ) : (
                ...
                <button
                  ...
                  disabled={generating}
                  className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed text-sm flex items-center gap-2 whitespace-nowrap"
                >
                  {generating ? (
                    <>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-[#0f1c35] border border-gray-200 dark:border-white/10 rounded-xl p-4 sm:p-6">
              <div className="flex items-start gap-4">
                <div className="p-3 bg-emerald-100 dark:bg-emerald-500/20 rounded-full flex-shrink-0">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-sm font-medium transition-all"
                  >
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <button
                    ...
                    className="inline-flex items-center mt-3 gap-2 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg text-sm font-medium transition-all"
                  >
                  ...
                  <tbody>
                    {referrals.map((referral) => (
                      ...
                      >
                        ...
                        <td className="py-5 px-4 text-sm font-semibold text-emerald-600 dark:text-emerald-400">
                          $
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    readOnly
                    className="flex-1 px-4 py-3 bg-gray-50 dark:bg-[#0f1c35] border border-gray-200 dark:border-white/10 rounded-lg text-sm text-gray-700 dark:text-gray-300 font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500"
                  />
                  <button
                    onClick={handleModalCopy}
                    className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-all shadow-sm flex items-center justify-center gap-2 whitespace-nowrap"
                  >
                    {modalCopied ? (
                      <>
                        <Check className="w-5 h-5" />

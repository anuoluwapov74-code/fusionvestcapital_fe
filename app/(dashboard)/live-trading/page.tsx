  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Info Card */}
        <div className="mb-6 bg-emerald-500/10 dark:bg-emerald-500/20 border border-emerald-500/30 dark:border-emerald-500/40 rounded-lg p-4">
        ...
        <div className="mb-8 flex justify-center">
          <motion.button
            ...
            className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 text-white text-sm font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-3"
            animate={{
              y: [0, -10, 0],
            }}
            transition={{
            ...
            >
              ...
              >
                ...
                <div className="p-6 space-y-6">
                  ...
                  {/* Next Steps */}
                  <div className="bg-gradient-to-r from-emerald-50 to-emerald-100 dark:from-emerald-500/10 dark:to-emerald-600/10 rounded-xl p-4 border border-emerald-200 dark:border-emerald-500/20">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 pt-4 border-t border-gray-200 dark:border-white/10">
                    <p>
                      ...
                      than your original investment. FUSIONVEST CAPITAL does not provide investment

...
const Hero = () => {
  ...
  return (
    <section className="relative overflow-hidden bg-[#00001a] lg:min-h-[calc(100vh-80px)]">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 pb-10 lg:pt-12 lg:pb-14">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <h1 className="text-[1.6rem] sm:text-[2.4rem] lg:text-[3.2rem] font-black leading-[1.08] tracking-tight text-white mb-5">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-white/55 leading-relaxed mx-auto max-w-2xl mb-8">
...
const StatBar = () => {
  ...
  return (
    <section className="bg-[#000080] py-0">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-2 lg:grid-cols-4 divide-x divide-white/10 divide-y lg:divide-y-0">
          {stats.map((s, i) => {
            ...
            return (
              <div key={i} ref={ref} className="flex flex-col items-center justify-center py-10 px-6 text-center">
  ...
  <section className="py-24 lg:py-36">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Challenge */}
        <div className="group relative overflow-hidden rounded-3xl border border-red-200/50 dark:border-red-800/30 bg-red-50/70 dark:bg-red-950/30 backdrop-blur-sm p-10 lg:p-14 transition-all duration-300 hover:shadow-2xl hover:shadow-red-500/8">
        ...
        {/* Solution */}
        <div className="group relative overflow-hidden rounded-3xl border border-[#50C878]/20 dark:border-[#50C878]/20 bg-gradient-to-br from-[#50C878]/8 to-[#000080]/5 dark:from-[#50C878]/10 dark:to-[#000080]/20 backdrop-blur-sm p-10 lg:p-14 transition-all duration-300 hover:shadow-2xl hover:shadow-[#50C878]/10">
  ...
  <section className="py-24 lg:py-36">
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        {/* Large card */}
        <div className="lg:col-span-2 group relative overflow-hidden rounded-3xl border border-[#000080]/12 dark:border-[#50C878]/12 bg-gradient-to-br from-[#000080]/6 to-[#50C878]/4 dark:from-[#000080]/20 dark:to-[#50C878]/8 p-10 lg:p-14 transition-all duration-300 hover:border-[#000080]/25 dark:hover:border-[#50C878]/25 hover:-translate-y-1 hover:shadow-2xl hover:shadow-[#000080]/8 dark:hover:shadow-[#50C878]/8">
        ...
        <div className="grid grid-rows-2 gap-5">
          {[
            ...
            <div key={i} className="group relative overflow-hidden rounded-3xl border border-[#000080]/8 dark:border-[#50C878]/8 bg-white/60 dark:bg-white/[0.02] backdrop-blur-sm p-8 transition-all duration-300 hover:border-[#000080]/20 dark:hover:border-[#50C878]/20 hover:-translate-y-0.5 hover:shadow-xl">
              <div
        ...
        {!loading && traders.length > 0 && (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {traders.map((trader, i) => {
              ...
              return (
                <div key={i} className="group relative overflow-hidden rounded-3xl border border-[#000080]/10 dark:border-white/8 bg-white/60 dark:bg-white/[0.03] backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-[#000080]/10 dark:hover:shadow-[#50C878]/10 hover:border-[#000080]/20 dark:hover:border-[#50C878]/20">
                  {/* Gradient header */}
    ...
    <section className="py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-5">
          {items.map((item, i) => (
            <div key={i} className="group relative overflow-hidden rounded-3xl border border-[#000080]/8 dark:border-[#50C878]/8 bg-white/60 dark:bg-white/[0.02] backdrop-blur-sm p-7 lg:p-9 text-center transition-all duration-300 hover:-translate-y-1.5 hover:shadow-xl hover:border-[#000080]/20 dark:hover:border-[#50C878]/20">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-3 space-y-3">
            {faqData.map((faq, i) => (
              <div key={i} className="group rounded-3xl border border-[#000080]/8 dark:border-[#50C878]/8 bg-white/60 dark:bg-white/[0.02] backdrop-blur-sm overflow-hidden transition-all duration-300 hover:border-[#000080]/18 dark:hover:border-[#50C878]/18">
                <button
...
const FinalCTA = () => (
  <section className="relative overflow-hidden py-28 lg:py-40">
    ...
    <div className="relative mx-auto max-w-4xl px-4 text-center">
      <p className="text-sm font-black uppercase tracking-widest text-[#50C878] mb-6">Get Started</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        {[
          ...
          <div key={i} className="rounded-2xl border border-white/10 bg-white/6 backdrop-blur-sm p-6 text-left">

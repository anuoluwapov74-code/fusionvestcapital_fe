...
export default function KYCVerificationPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5ff] dark:bg-gradient-to-br dark:from-[#00002e] dark:via-[#000020] dark:to-[#000012] text-gray-900 dark:text-white transition-colors duration-300">
      {/* Banner Section */}
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
        <motion.div
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          className="relative bg-gradient-to-br from-[#000080] to-[#1a1aff] rounded-2xl overflow-hidden px-6 sm:px-10 py-8 sm:py-12 min-h-[180px] sm:min-h-[220px]"
        >
            ...
            <div key={index} className="flex items-center flex-1">
              <div className="flex flex-col items-center flex-1">
                <motion.div
                  ...
                  animate={{
                    ...
                    backgroundColor: index <= currentStage ? "rgb(0, 0, 128)" : "rgb(209, 213, 219)",
                  }}
                  transition={{ duration: 0.3 }}
                  className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-lg ${
                    index <= currentStage
                      ? "bg-[#000080] dark:bg-[#50C878]"
              ...
              {index < stages.length - 1 && (
                <div className={`h-1 flex-1 transition-all duration-500 ${
                  index < currentStage ? "bg-[#000080] dark:bg-[#50C878]" : "bg-gray-200 dark:bg-gray-700"
                }`} />
              )}
            </div>
          ))}
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit={{ opacity: 0, x: -50 }}
              transition={{ duration: 0.3 }}
              className="bg-white dark:bg-[#00003a]/40 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-white/10 shadow-lg"
            >
              <div className="flex items-start gap-4 mb-6">
                <div className="w-12 h-12 rounded-full bg-[#000080] dark:bg-[#50C878] flex items-center justify-center text-white font-bold text-xl flex-shrink-0">
                  {currentStage + 1}
                </div>
              ...
              {currentStage === 0 && (
                <div className="space-y-5">
                  <div>
                    ...
                    <select
                      {...register("title")}
                      className="w-full border rounded-lg px-4 py-3 bg-white dark:bg-[#00003a]/60 border-gray-300 dark:border-gray-600/50 focus:outline-none focus:ring-2 focus:ring-[#000080] dark:focus:ring-[#50C878]"
                    >
              ...
              {currentStage === 3 && (
                <div className="space-y-5">
                    ...
                    {!idFrontPreview ? (
                      <div
                        ...
                        className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-all ${
                          isDragActiveFront ? "border-[#000080] dark:border-[#50C878] bg-[#000080]/5 dark:bg-[#50C878]/5"
                            : uploadingFront ? "border-gray-400 bg-gray-100/50 dark:bg-gray-800/50 cursor-not-allowed"
                            : "border-gray-300 dark:border-gray-600/50 hover:border-[#000080]/50 dark:hover:border-[#50C878]/50"
                        }`}
                      >
                      ...
                      <div className="relative w-full h-48 group rounded-lg overflow-hidden">
                        ...
                        {uploadingFront && (
                          <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex flex-col items-center justify-center z-10">
                            <Loader2 className="w-10 h-10 text-[#000080] dark:text-[#50C878] animate-spin mb-3" />
                  ...
                  <div>
                    ...
                    {!idBackPreview ? (
                      <div
                        {...getRootPropsBack()}
                        className={`border-2 border-dashed rounded-lg p-8 text-center cursor-pointer transition-all ${
                          isDragActiveBack ? "border-[#000080] dark:border-[#50C878] bg-[#000080]/5 dark:bg-[#50C878]/5"
                  ...
                  <div className="bg-[#000080]/5 dark:bg-[#50C878]/8 border-2 border-[#000080]/15 dark:border-[#50C878]/20 rounded-xl p-6 mt-8">
                    <div className="flex items-start gap-4 mb-4">
                      <div className="w-10 h-10 rounded-full bg-[#000080] dark:bg-[#50C878] flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 ml-14">
                      <div className="flex items-center gap-2">
                        <Lock className="w-4 h-4 text-[#000080] dark:text-[#50C878] flex-shrink-0" />
                        <span className="text-xs text-gray-700 dark:text-gray-300">SSL encryption</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <CheckCircle2 className="w-4 h-4 text-[#000080] dark:text-[#50C878] flex-shrink-0" />
                        <span className="text-xs text-gray-700 dark:text-gray-300">Two-factor authentication</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Shield className="w-4 h-4 text-[#000080] dark:text-[#50C878] flex-shrink-0" />
                        <span className="text-xs text-gray-700 dark:text-gray-300">Regular security audits</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <FileCheck className="w-4 h-4 text-[#000080] dark:text-[#50C878] flex-shrink-0" />
              ...
              <div className="flex gap-4 mt-8">
                ...
                {currentStage < 3 ? (
                  <button
                    type="button"
                    onClick={handleNext}
                    className="flex-1 bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] text-white dark:text-[#000025] py-3 rounded-lg font-semibold transition-all flex items-center justify-center gap-2"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] text-white dark:text-[#000025] py-3 rounded-lg font-semibold transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {loading ? (
                      <>

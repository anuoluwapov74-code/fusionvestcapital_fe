...
function RegisterPageContent() {
  ...
  return (
    <PagePreloader>
      <div className="min-h-screen flex flex-col lg:flex-row gap-10 bg-[#f5f5ff] dark:bg-gradient-to-br dark:from-[#00002e] dark:via-[#000020] dark:to-[#000012] text-black dark:text-white transition-colors duration-300">
      {/* Left side: Register Form */}
      <div className="flex-1 flex items-center justify-center px-8 py-8 md:py-16 bg-[#f5f5ff] dark:bg-transparent">
        <motion.div
        ...
        >
          ...
          {mounted && (
            <button
              ...
              className="p-2 ml-auto rounded-md border fixed top-5 right-1 border-gray-300 dark:border-gray-600/50 hover:bg-gray-100 dark:hover:bg-[#00003a]/30 transition-all"
            >
              {theme === "light" ? (
                <Moon className="w-4 h-4 text-[#000080]" />
              ) : (
                <Sun className="w-4 h-4 text-[#50C878]" />
              )}
            </button>
          )}
          ...
          {referralCode && referralValid && (
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className="bg-[#000080]/6 dark:bg-[#50C878]/8 border border-[#000080]/20 dark:border-[#50C878]/20 rounded-lg p-4"
            >
              <div className="flex items-center gap-3">
                <div className="p-2 bg-[#000080]/8 dark:bg-[#50C878]/15 rounded-full">
                  <Gift className="w-5 h-5 text-[#000080] dark:text-[#50C878]" />
                </div>
                <div>
                  <p className="text-sm font-semibold text-[#000080] dark:text-[#50C878]">
                    🎉 Referred by {referrerName}!
                  </p>
                  <p className="text-xs text-[#000080]/70 dark:text-[#50C878]/80">
          ...
          <div>
            ...
            <p className="text-left text-sm mt-4">
              ...
              <Link
                href="/login"
                className=" text-[#000080] dark:text-[#50C878] underline"
              >
                Sign In here
              </Link>
            </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                <input
                  ...
                  type="text"
                  {...register("firstName")}
                  className={`peer w-full border rounded-md px-3 pt-5 pb-2 bg-white dark:bg-[#00003a]/60 focus:outline-none transition-all ${
                    errors.firstName
                      ? "border-red-500"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] text-white dark:text-[#000025] py-6 rounded-md"
            >
              {!loading ? (
            ...
            <button
              type="button"
              className="w-full flex items-center justify-center gap-3 py-3 border border-gray-300 dark:border-gray-600/50 rounded-md bg-white dark:bg-[#00003a]/60 hover:bg-gray-50 dark:hover:bg-[#00003a]/80 transition-all"
            >
      ...
      {/* Right side visual */}
      <div className="hidden flex-1 items-center justify-center bg-gradient-to-br from-[#000080] via-[#0000b3] to-[#000060] dark:from-[#00002e] dark:via-[#000040] dark:to-[#00002e] p-8 rounded-l-3xl">
        <motion.div

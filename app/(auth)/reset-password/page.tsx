...
function ResetPasswordContent() {
  ...
  if (validating) {
    return (
      <PagePreloader>
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gradient-to-br dark:from-[#00002e] dark:via-[#000020] dark:to-[#000012]">
  ...
  if (!tokenValid) {
    return (
      <PagePreloader>
        <div className="min-h-screen flex items-center justify-center bg-white dark:bg-gradient-to-br dark:from-[#00002e] dark:via-[#000020] dark:to-[#000012] px-8">
        <motion.div
        ...
        >
          ...
          <div className="space-y-3">
            <Link href="/forgot-password">
              <Button className="w-full bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] text-white dark:text-[#000025] mb-4">
      ...
      <PagePreloader>
        ...
        >
          <div className="w-20 h-20 bg-[#000080]/8 dark:bg-[#50C878]/15 rounded-full flex items-center justify-center mx-auto">
            <CheckCircle className="w-10 h-10 text-[#000080] dark:text-[#50C878]" />
          </div>
          ...
          <div className="pt-4">
            <Link href="/login">
              <Button className="w-full bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] text-white dark:text-[#000025]">
                Continue to Login
              </Button>
            </Link>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="relative">
            <input
              ...
              className={`peer w-full border rounded-md px-3 pt-5 pb-2 bg-white dark:bg-[#00003a]/60 text-black dark:text-white focus:outline-none transition-all ${
                errors.new_password
                  ? "border-red-500"
          ...
          <p className="text-center text-sm text-gray-600 dark:text-gray-400">
            ...
            <Link href="/login" className="text-[#000080] dark:text-[#50C878] hover:underline">
              Sign in
            </Link>
          </p>
        </form>

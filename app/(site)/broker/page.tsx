        ...
        <section className="relative overflow-hidden bg-white dark:bg-gray-900/50 py-24 lg:py-36">
          ...
          <div className="relative mx-auto max-w-3xl px-6 text-center">
            <h1 className="text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white sm:text-6xl lg:text-7xl italic">
              ...
              <span className="bg-linear-to-r from-[#000080] to-[#1a1aff] dark:from-[#50C878] dark:to-[#6de496] bg-clip-text text-transparent">
                Brokerage
              </span>
            </h1>
            ...
            <div className="mt-10">
              <Link
                href="/register"
                className="inline-block rounded-md bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] px-8 py-3.5 text-sm font-semibold text-white dark:text-[#000025] transition shadow-lg shadow-[#000080]/30 dark:shadow-[#50C878]/30 hover:shadow-[#000080]/50 dark:hover:shadow-[#50C878]/50"
              >
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-gray-200 dark:bg-white/10 rounded-2xl overflow-hidden border border-gray-200 dark:border-white/10">
              ...
              <div className="bg-white dark:bg-gray-900/80 p-10">
                <div className="mb-5 text-[#000080] dark:text-[#50C878]">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
        ...
        <section className="bg-gray-100 dark:bg-gray-800/30 px-6 py-16 lg:py-24">
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 text-center">
              <div>
                <span className="text-[#000080] dark:text-[#50C878] font-semibold text-sm">
                  1
                </span>
              ...
              <div>
                ...
                <Link
                  href="/register"
                  className="mt-2 inline-block text-[#000080] dark:text-[#50C878] hover:text-[#0000b3] dark:hover:text-[#6de496] text-sm font-medium transition"
                >
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              ...
              <div className="flex flex-col items-center rounded-2xl bg-white/70 dark:bg-white/5 backdrop-blur-sm border border-gray-200/80 dark:border-white/8 px-8 py-12 text-center shadow-sm">
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-lg bg-[#000080]/6 dark:bg-[#50C878]/10">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    fill="none"
                    className="text-[#000080] dark:text-[#50C878]"
                  >
                    <path
                      d="M12 5v14M5 12h14"
                      stroke="currentColor"
        ...
        <section className="bg-gray-100 dark:bg-gray-800/30 px-6 py-16 lg:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8">
              <Link
                href="/register"
                className="inline-block rounded-md bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] px-10 py-4 text-sm font-semibold text-white dark:text-[#000025] transition shadow-lg shadow-[#000080]/30 dark:shadow-[#50C878]/30 hover:shadow-[#000080]/50 dark:hover:shadow-[#50C878]/50"
              >

        ...
        <div className="max-w-4xl mx-auto px-6 py-12 lg:py-20">
          <div className="mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Everything you need to know to get started with copy trading on FUSIONVEST CAPITAL
            </p>
          </div>
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Welcome to FUSIONVEST CAPITAL! This guide will walk you through everything you need to know
                to start copy trading. Whether you are a complete beginner or an experienced trader
                looking to diversify, FUSIONVEST CAPITAL makes it easy to follow top-performing traders and
            ...
            <section>
              ...
              <ol className="space-y-3 text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-3">
                  ...
                  <span>Visit the FUSIONVEST CAPITAL registration page and enter your email address and a strong password</span>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  <span className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-7 h-7 flex items-center justify-center text-sm font-bold shrink-0">3</span>
                  <span>Complete the KYC verification process by uploading your identification documents</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-7 h-7 flex items-center justify-center text-sm font-bold shrink-0">4</span>
                  <span>Fund your account with your preferred deposit method</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-7 h-7 flex items-center justify-center text-sm font-bold shrink-0">5</span>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                FUSIONVEST CAPITAL provides powerful tools to help you find the right traders to copy:
              </p>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                FUSIONVEST CAPITAL supports multiple funding methods for your convenience:
              </p>
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-3">
                  <span className="text-[#000080] dark:text-[#50C878] font-bold">&#8226;</span>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                If you need assistance at any point, FUSIONVEST CAPITAL offers multiple support channels:
              </p>
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-3">
                  <span className="text-[#000080] dark:text-[#50C878] font-bold">&#8226;</span>
            ...
            <section className="bg-gray-100 dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Create your FUSIONVEST CAPITAL account today and start copying top-performing traders.
                It only takes a few minutes to get started.
              </p>
              <div className="flex flex-wrap gap-4">
                <Link href="/register" className="inline-block bg-[#000080] hover:bg-[#0000b3] dark:bg-[#50C878] dark:hover:bg-[#3ab060] text-white dark:text-[#000025] px-8 py-3 rounded-full font-semibold transition-all duration-300 shadow-lg shadow-[#000080]/30 dark:shadow-[#50C878]/30 hover:shadow-[#000080]/50 dark:hover:shadow-[#50C878]/50">
                  Get Started
                </Link>

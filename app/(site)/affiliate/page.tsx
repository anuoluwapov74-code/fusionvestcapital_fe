        ...
        <div className="max-w-4xl mx-auto px-6 py-12 lg:py-20">
          <div className="mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              Earn commissions by referring traders to FUSIONVEST CAPITAL
            </p>
          </div>
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                The FUSIONVEST CAPITAL Affiliate Program rewards you for introducing new traders to our
            ...
            <section>
              ...
              <div className="bg-[#000080]/8 dark:bg-[#50C878]/8 border border-[#000080]/15 dark:border-[#50C878]/15 rounded-xl p-6 mb-6">
                <p className="text-3xl font-bold text-[#000080] dark:text-[#50C878] mb-2">10% Referral Bonus</p>
            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">1</div>
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-1">Sign Up</h3>
                    <p className="text-gray-700 dark:text-gray-300">
                      Create your FUSIONVEST CAPITAL account and apply for the Affiliate Program through your dashboard.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">2</div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">3</div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="bg-[#000080] dark:bg-[#50C878] text-white dark:text-[#000025] rounded-full w-10 h-10 flex items-center justify-center text-lg font-bold shrink-0">4</div>
                  <div>
            ...
            <section>
              ...
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#000080] dark:text-[#50C878] font-bold">&#8226;</span>
                  <span>Always disclose your affiliate relationship when promoting FUSIONVEST CAPITAL</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#000080] dark:text-[#50C878] font-bold">&#8226;</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-[#000080] dark:text-[#50C878] font-bold">&#8226;</span>
                  <span>Do not bid on FUSIONVEST CAPITAL branded keywords in paid advertising</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#000080] dark:text-[#50C878] font-bold">&#8226;</span>
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                FUSIONVEST CAPITAL reserves the right to terminate affiliate partnerships under the following
                circumstances:
              </p>
              <ul className="space-y-2 text-gray-700 dark:text-gray-300">
                <li className="flex items-start gap-3">
            ...
            <section className="bg-gray-100 dark:bg-gray-900 rounded-2xl p-8 border-2 border-gray-200 dark:border-gray-800">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                Join the FUSIONVEST CAPITAL Affiliate Program today. Sign up, get your referral link,

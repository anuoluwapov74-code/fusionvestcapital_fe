          ...
          <div className="space-y-12">
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                FUSIONVEST CAPITAL is committed to protecting your privacy. This Privacy Policy
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                When you open an account with FUSIONVEST CAPITAL, we collect personal information
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                FUSIONVEST CAPITAL employs industry-standard security measures to protect your
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                FUSIONVEST CAPITAL may share your personal information with our affiliated
            ...
            <section>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                FUSIONVEST CAPITAL may be required to disclose your personal information to
